...
import { RcMainLayoutComponent } from './RC/ui/layouts/rc-main-layout/rc-main-layout.component';
import { EdMainLayoutComponent } from './ED/ui/layouts/ed-main-layout/ed-main-layout.component';
import { CommonMainLayoutComponent } from './common-features/ui/layouts/common-main-layout/common-main-layout.component';
import { GuMainLayoutComponent } from './GU/ui/layouts/gu-main-layout/gu-main-layout.component';
import { InMainLayoutComponent } from './IN/ui/layouts/in-main-layout/in-main-layout.component';
import { ReMainLayoutComponent } from './RE/ui/layouts/re-main-layout/re-main-layout.component';
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        title: 'RC',
        path: 'rc',
        component: RcMainLayoutComponent,
        children: [
          {
            title: 'RCPays',
            path: 'rc-payss',
      ...
      {
        path: 'gu',
        component: GuMainLayoutComponent,
        children: [
      ...
      },
      {
        title: 'IN',
        path: 'in',
        component: InMainLayoutComponent,
        children: [
      ...
      },
      {
        title: 'RE',
        path: 're',
        component: ReMainLayoutComponent,
        children: [
      ...
      },
      {
        title: 'ED',
        path: 'ed',
        component: EdMainLayoutComponent,
        children: [
